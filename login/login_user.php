<?php
session_start();
include '../db_php/db_connection.php'; // Pastikan path ke file koneksi sudah benar
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            header('Location: ../dashboard/dashboard_user.php'); // Ganti dengan halaman dashboard yang sesuai
            exit();
        } else {
...
<body>
    <div class="form sign-in">
        ...
        <?php endif; ?>
        <p><a href="../lupa password/lupa_password.php">Lupa Password?</a></p>
        <p>Belum punya akun? <a href="../signup/signup.php" class="switch-btn">Buat Akun</a></p>
    </div>
</body>
</html>
